...
const About = () => {
  ...
  return (
    <div className="w-full min-h-screen">
      <div
        id="hero"
        className="hero w-full min-h-max bg-gray-300 h-[80vh] lg:h-[90vh] flex flex-col justify-center gap-14 lg:gap-6 mt-10 md:mt-0 lg:pt-32 text-center relative bg-cover bg-center overflow-hidden"
      >
        ...
        <div className="w-full h-full flex justify-center items-center overflow-hidden">
          <img
            ...
            alt=""
            className="object-cover object-center w-full h-full max-h-[80vh] lg:max-h-[90vh]"
