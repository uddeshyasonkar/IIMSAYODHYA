...
const About = () => {
  ...
  return (
    <div className="w-full min-h-screen">
      <div
        id="hero"
        className="hero w-full min-h-max bg-gray-300 h-[50vh] lg:h-[90vh] flex flex-col justify-center gap-14 lg:gap-6 mt-10 md:mt-0 lg:pt-32 text-center relative bg-cover bg-center overflow-hidden"
      >
        ...
        <div className="w-full h-full flex justify-center items-center overflow-hidden">
          <img
            ...
            alt=""
            className="object-cover object-center w-full h-[50vh] lg:h-[890vh] max-h-[80vh] lg:max-h-[90vh]"
            style={{ maxWidth: "100%", maxHeight: "100%" }}
          />
        </div>

        <div className="border-black border-2 py-2 rounded-full bg-project-white w-[90%] lg:w-[50%] flex justify-center items-center gap-5 lg:gap-30 absolute bottom-2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
          <div className="Zilla flex flex-col">
            <span className="font-bold text-xl lg:text-3xl text-project-red">
              1000+
            </span>
      ...
      {/* <div className="py-12 flex justify-center items-center">
        <div className="border-black border-2 py-2 rounded-full bg-project-white w-[90%] lg:w-[50%] flex justify-center items-center gap-5 lg:gap-30 ">
          <div className="Zilla flex flex-col">
            <span className="font-bold text-xl lg:text-3xl text-project-red">
              1000+
            </span>
