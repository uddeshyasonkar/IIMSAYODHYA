  ...
  return (
    <div className="w-full min-h-screen">
      ...
      >
        ...
        <div className="border-black border-0 lg:border-2 lg:mt-10 mt-0 py-6 rounded-[70px]  w-[90%] lg:w-[80%] flex flex-col  items-center  lg:items gap-6 lg:gap-3 p-10">
          {/* B pharma */}
          ...
          {/* GNM, ANM, Bsc Nursing */}
          <div className="w-full lg:w-[90%] lg:px-2 Zilla flex flex-col lg:flex-row  items-center gap-5 lg:gap-16 ">
            <div className="">
              <img
